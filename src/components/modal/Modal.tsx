...
import { CustomSlottedComponent } from "@/types/type-util";
    ...
    <>
      {isMd ? (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          >
            <div className="dark:from-primary-dark-foreground relative flex flex-1 flex-col overflow-hidden rounded-[calc(var(--radius-2xl)-(--spacing(1.5)))] bg-linear-to-b from-gray-100">
              {/* pattern */}
              <Grid
                width={30}
                height={30}
                ...
                strokeDasharray={"4 2"}
                className={cn(
                  "inset-0 h-40 mask-[linear-gradient(180deg,white,transparent)] opacity-20",
                )}
              />
              {/* pattern */}
                  ...
                  {showClose && (
                    <div className="absolute top-5 right-5">
                      <Button
                        ...
                        border={false}
                        className={
                          "dark:ring-offset-primary-dark-foreground -mt-2 flex shrink-0 items-center justify-center rounded-full border bg-gray-100 p-0.5 ring-gray-300 hover:bg-gray-200 data-pressed:bg-gray-200 md:p-0.5 dark:bg-white/10 dark:text-white dark:hover:bg-white/20 dark:data-pressed:bg-white/20"
                        }
                      >
        ...
        <Drawer shouldScaleBackground open={isOpen} onOpenChange={setIsOpen}>
          ...
          >
            <div className="dark:bg-primary-dark flex h-full flex-1 flex-col overflow-hidden rounded-t-2xl border border-gray-300 bg-white p-1.5 dark:border-white/10">
              <div className="dark:from-primary-dark-foreground dark:to-primary-dark relative flex flex-1 flex-col overflow-hidden rounded-[calc(var(--radius-2xl)-(--spacing(1.5)))] bg-linear-to-b from-gray-100 to-white">
                {/* pattern */}
                <Grid
                  width={30}
                  height={30}
